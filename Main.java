...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        //Capturer c2 = new Capturer("greater 1450 and less 1450 and port 777",5000);
        ...
        double secs2 = time2[0] * 60  + time2[1];
        //secs2 = time2[0] * 60  + time2[1];

        System.out.println("Diff in seconds : " + (secs2 - secs1));
        System.out.println("Rate :" +  ((10000*1425) / ((secs2 - secs1) * 1024 * 1024)));
    }
}